...
/**
 * Created by NocodeLee on 16/5/24.
...
public class WaterDropView extends View {
    ...
    if (attrs != null) {
      ...
      try {
        ...
        if (a.hasValue(R.styleable.WaterDropView_max_circle_radius)) {
          mMaxCircleRadius =
              a.getDimensionPixelSize(R.styleable.WaterDropView_max_circle_radius, 0);
        ...
        if (a.hasValue(R.styleable.WaterDropView_min_circle_radius)) {
          mMinCircleRaidus =
              a.getDimensionPixelSize(R.styleable.WaterDropView_min_circle_radius, 0);
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    RectF bitmapArea = new RectF(topCircle.getX() - 0.5f * topCircle.getRadius(),
  ...
  private double getAngle() {
    ...
    return Math.asin((topCircle.getRadius() - bottomCircle.getRadius()) / (bottomCircle.getY()
        - topCircle.getY()));
  }
