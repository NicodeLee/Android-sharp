...
public class StickinessView extends View {
  ...
  @Override public void onDraw(Canvas canvas) {
    ...
    if (mIsRotating) {
      ...
      mPath.cubicTo(mTopBound.right - mTopSize / 8, mTopBound.bottom,
          mTopBound.right - bottomControlXOffset, bottomControlY, mBottomBound.right,
      ...
      mPath.cubicTo(mTopBound.left + bottomControlXOffset, bottomControlY,
          mTopBound.left + mTopSize / 8, mTopBound.bottom, mTopBound.left,
