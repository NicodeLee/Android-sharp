...
public class AppUtils {
   ...
   * <li>if one process of {@link ActivityManager#getRunningAppProcesses()} is equal to processName,
   * return
  ...
  public static boolean isNamedProcess(Context context, String processName) {
    ...
    for (RunningAppProcessInfo processInfo : processInfoList) {
      if (processInfo != null && processInfo.pid == pid && ObjectUtils.isEquals(processName,
