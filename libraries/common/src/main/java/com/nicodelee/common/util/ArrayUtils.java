package com.nicodelee.common.util;

/**
 * Array Utils
 * <ul>
 * <li>{@link #isEmpty(Object[])} is null or its length is 0</li>
 * <li>{@link #getLast(Object[], Object, Object, boolean)} get last element of the target element,
 * before the first one
 * that match the target element front to back</li>
 * <li>{@link #getNext(Object[], Object, Object, boolean)} get next element of the target element,
 * after the first one
 * that match the target element front to back</li>
...
public class ArrayUtils {
  ...
  /**
   * get next element of the target element, after the first one that match the target element
   * front
   * to back
   * <ul>
   * <li>if array is empty, return defaultValue</li>
